...
# Prophet is an open source forecasting tools for time series data based on an additive model where non-linear trends.
...
if __name__ == "__main__":
    ...
    file_path = './input_data/kaggle_store_data/train.csv'
